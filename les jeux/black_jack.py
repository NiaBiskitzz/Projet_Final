...
Le donneur distribue une carte visible au joueur. 
...
def black_jack():
    ...
    if Player1_card1['value'] + Player1_card2['value'] + Player1_card3['value'] > Player2_card1['value'] + Player2_card2['value'] + Player2_card3['value']:
        print("Player1 a gagné")
    elif Player1_card1['value'] + Player1_card2['value'] + Player1_card3['value'] < Player2_card1['value'] + Player2_card2['value'] + Player2_card3['value']:
        print("Player2 a gagné")