def trivia_game():
    ...
    Geographie = {
        "Quel pays possède le plus grand nombre d’îles dans le monde?": "Suède",
        "Quel est le plus petit pays du monde?": "Vatican",
        "Quel est la capital du Canada": " Ottawa",
        "Citez le nom de la plus vaste chaine de montagne": "les Andes",
        "Citez le nom du plus long fleuve du monde": "le Nil",
        "Quel est le site naturel le plus bas de la planete terre": "la fosse de Mariannes"
    }

    kings_and_queens_of_rock = {
        "Who is known as the 'King of Rock and Roll'?": "Elvis Presley",
        "Who is known as the 'Queen of Rock and Roll'?": "Tina Turner",
        "Who is known as the 'Godfather of Soul'?": "James Brown",
        "Who is known as the 'King of the Blues'?": "B.B. King",
        ...
        "Who is known as the 'King of Punk'?": "Iggy Pop",
        "Who is known as the 'Queen of Punk'?": "Patti Smith",
        "Who is known as the 'King of Metal'?": "Ozzy Osbourne",
        "Who is known as the 'Queen of Metal'?": "Lita Ford",
        "Who is known as the 'King of Rockabilly'?": "Elvis Presley",
        "Who is known as the 'Queen of Rockabilly'?": "Wanda Jackson",
        "Who is known as the 'King of Country'?": "George Strait",
    }
    ...
    game_theme = input("Select 1 pour Films, 2 pour Geographie, 3 pour Kings and Queens of Rock!  ")
    print(game_theme)
    game_data = {}
    if game_theme == "1":
        game_data = Films
    ...
    player_count = input("combien de joueur? (1 , 2, or 3)")
    ...
    while counter <= fixed_game_length:
        ...
        if answer_question == game_data.get(question):
            ...
            print("Correct! " + "vous avez fait un point. " + "tu a " + str(scores[player_num - 1]) + " points.")
        else:
